...
class ExcelToken(Token):
    ...
    #     url = f'''xmlns="http://canarytokens.com/feedback/terms/xbjoqkzhiy9d3z1xcywh3ffng/contact.php"'''
    ...
    def write_out(self):
        ...
        # url = "http://canarytokens.com/feedback/terms/xbjoqkzhiy9d3z1xcywh3ffng/contact.php"
